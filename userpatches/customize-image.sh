...
sed -i 's@*/15@#*/15@g' /etc/cron.d/armbian-truncate-logs
sed -i 's&@reboot&#@reboot&g' /etc/cron.d/armbian-truncate-logs
sed -i 's@systemctl@#systemctl@g' /etc/cron.daily/armbian-ram-logging
sed -i 's@/usr@#/usr@g' /etc/cron.daily/armbian-ram-loggin
